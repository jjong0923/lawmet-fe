  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <BoxWrapper>
        ...
        현재 사용자는 학원 조교로 약 1년 이상 근무 중이며,{"\n"} 근로계약서상
        근무시간은 15:00~18:00으로 명시되어{"\n"} 있으나 실제로는 지속적인
        연장근로가 발생하고 있습니다.
      ...
      <p className="text-primary-color-2 border-primary-color-2 mt-6 cursor-pointer border-b text-[10px] font-semibold">
        자세히 알아보기
      </p>
    </div>
  );
